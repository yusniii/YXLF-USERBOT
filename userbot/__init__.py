...
KYY_TEKS_KUSTOM = os.environ.get("KYY_TEKS_KUSTOM", "I'am Using **YXLF-USERBOT**✨")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/4cfa199028f74e0f064d1.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/4cfa199028f74e0f064d1.jpg"
...
async def checking():
    gocheck = str(pybase64.b64decode("QHl4eHh6bg=="))[2:15]
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**✨ YXLF-USERBOT Inline Menu ✨**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules"
                await event.edit(
                    text,
                    file=kyylogo,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@KyyUserbot"):
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository YXLF - Userbot",
                ...
                result = builder.article(
                    title="✨ YXLF-Userbot ✨",
                    description="YXLF - Userbot | Telethon",
                    url="https://t.me/randomajaboss",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
