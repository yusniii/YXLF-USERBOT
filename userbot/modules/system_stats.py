...
import psutil
from userbot import ALIVE_LOGO, ALIVE_NAME, BOT_VER, CMD_HELP, YXZN_TEKS_KUSTOM, StartTime, UPSTREAM_REPO_BRANCH, bot, CMD_HANDLER as cmd
...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            "**⚜-**✨ʏxʟꜰ-ᴜsᴇʀʙᴏᴛ✨ Versi:** \n "
            f"heads/YXLF-USERBOT-0-x634i7u1"
            "\n**⚜-**Revisi:**\n "
            f"{revout}"
        )
    else:
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/Kenzusupport) | [ᴄʜᴀɴɴᴇʟ](https://t.me/inibotsaya) | [ᴏᴡɴᴇʀ](https://t.me/yxxxznal1_bot) | [ɢɪᴛʜᴜʙ](https://github.com/yusniii/YXLF-USERBOT)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
...
async def amireallyalive(alive):
    ...
    output = (
        f"●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬● \n"
        f"✾ 🤴 • `ᴏᴡɴᴇʀ    :`[yxzn](t.me/yxxxznal1_bot) \n"
...
async def redis(alive):
    ...
    output = (
        ...
        f"┣  **Owner    :** [yxzn](https://t.me/yxxxznal1_bot) \n"
        f"┗━━━━━━━━━━━━━━━━━━━━━")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
